...
import cn.mysilicon.housekeep.Adapter.HomeAdapter;
import cn.mysilicon.housekeep.Adapter.MenuAdapter;
...
public class Fragment2 extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Fresco.initialize(this.requireActivity());
        initView();
        loadData();
    }
    ...
    private void loadData() {
        ...
        String json = getJson((MainActivity) this.requireActivity(), "category.json");
    ...
    private void initView() {
        lv_menu = (ListView) requireActivity().findViewById(R.id.lv_menu);
        tv_title = (TextView) requireActivity().findViewById(R.id.tv_titile);
        lv_home = (ListView) requireActivity().findViewById(R.id.lv_home);
        menuAdapter = new MenuAdapter(this.requireActivity(), menuList);
        lv_menu.setAdapter(menuAdapter);

        homeAdapter = new HomeAdapter(this.requireActivity(), homeList);
