...
import cn.mysilicon.housekeep.view.GridViewForScrollView;
...
public class HomeAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        cn.mysilicon.housekeep.Adapter.HomeItemAdapter adapter = new cn.mysilicon.housekeep.Adapter.HomeItemAdapter(context, dataList);
